...
import net.andy.boiling.util.FrameAnimationUtil;
...
public class SwitchButton extends CheckBox {
    ...
    private final class SwitchAnimation implements Runnable {
        ...
        public void run() {
            ...
            doAnimation();
            FrameAnimationUtil.requestAnimationFrame(this);
        }
    }

    private void doAnimation() {
        mAnimationPosition += mAnimatedVelocity * FrameAnimationUtil.ANIMATION_FRAME_DURATION
                / 1000;
