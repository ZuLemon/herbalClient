...
public class ReportUtil {
    ...
    public Integer getNoDispensingByRule(Integer ruleId) throws Exception {
        ...
        returnDomain = (ReturnDomain) Http.post ( "report/dispensing/getNoDispensingByRule.do", pairs, ReturnDomain.class );
    ...
    public List getNoDispensing() throws Exception {
        List<NameValuePair> pairs = new ArrayList<NameValuePair>();
        returnDomain = (ReturnDomain) Http.post ( "report/dispensing/getNoDispensing.do", pairs, ReturnDomain.class );
        if ( returnDomain.getSuccess () ) {
    ...
    public Integer getDispensingByUser(String userId) throws Exception {
        ...
        returnDomain = (ReturnDomain) Http.post ( "report/dispensing/getDispensingByUser.do", pairs, ReturnDomain.class );
        if ( returnDomain.getSuccess () ) {
            return JSON.parseObject ( returnDomain.getObject ().toString (),  Integer.class);
        } else {
            throw new Exception ( returnDomain.getException () );
